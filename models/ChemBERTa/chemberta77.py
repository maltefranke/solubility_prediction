...
class ChemBERTa(pl.LightningModule):
    def __init__(self,
        ...
        if weights:
            ...
            print("*************************************************************")
            self.Loss = nn.CrossEntropyLoss(weight=torch.Tensor([0.9711, 0.9599, 0.068]), reduction='mean')

        else:
            print("****************************************************************")
            print("*************** training WITHOUT weighted loss *****************")
            print("****************************************************************")
            self.Loss = nn.CrossEntropyLoss(weight=torch.Tensor([0.9711, 0.9599, 0.068]), reduction='mean')
        ...
        self.pretrained = "DeepChem/ChemBERTa-77M-MLM"
    ...
    def test_epoch_end(self, outputs):
        ...
        all_outs.to_csv("submission_chemberta77_weights.csv", index=False)
