...
def get_flexible_categorical_config(max_features):
    ...
    config_flexible_categorical = {
        ...
        "nan_prob_a_reason": CSH.CategoricalHyperparameter(
            "nan_prob_a_reason", [0.0]
        ),
        # "num_classes": lambda : random.randint(2, 10), "balanced": False,
        "max_num_classes": 2,
        "num_classes": 2,
        "noise_type": CSH.CategoricalHyperparameter(
            "noise_type", ["Gaussian"]
        ),  # NN
        "balanced": True,
...
def get_prior_config_gp(max_features=10000):  # <- modified, it was 100
...
def get_prior_config_bnn(max_features=10000):  # <- modified, it was 100
    config_general = get_general_config(max_features, 50, eval_positions=[30])
    config_general_real_world = {**config_general}
...
def get_prior_config_causal(max_features=10000):  # <- modified, it was 100
    config_general = get_general_config(max_features, 50, eval_positions=[30])
    config_general_real_world = {**config_general}
