...
def get_prior_config_gp(max_features=10000):  # <- modified
...
def get_prior_config_bnn(max_features=10000):  # <- modified
    config_general = get_general_config(max_features, 50, eval_positions=[30])
    config_general_real_world = {**config_general}
...
def get_prior_config_causal(max_features=10000):  # <- modified
    config_general = get_general_config(max_features, 50, eval_positions=[30])
    config_general_real_world = {**config_general}
