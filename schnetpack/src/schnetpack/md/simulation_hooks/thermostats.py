...
if TYPE_CHECKING:
    from schnetpack.src.schnetpack.md.simulator import Simulator, System

from schnetpack.src.schnetpack import units as spk_units
from schnetpack.src.schnetpack.md.simulation_hooks.basic_hooks import SimulationHook

from schnetpack.src.schnetpack.md.utils import YSWeights, load_gle_matrices
