...
if TYPE_CHECKING:
    from schnetpack.src.schnetpack.md import Simulator, System
...
from schnetpack.src.schnetpack.md.simulation_hooks import SimulationHook
from schnetpack.src.schnetpack.md.utils import StableSinhDiv, YSWeights
